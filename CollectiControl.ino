 ...
 *Karla Valeria Guerrero Hernández
 *Diana Palacios Rodríguez
 *Kevin Dilan Rangel Campos 
 *Descripcion: Control remoto mediante una app en Android Studio para manejar un prototipo robotico que recolecte basura
 */
...
void loop(){
  ...
  if (SerialBT.available()) { //Validación del funcionamiento del socket
    ...
    /*Se envia la coordenada total a la app para ser subida a la base de datos*/
    if(message=="f"){  
